<template>
  <div
    class="w-full max-w-md mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md"
  >
    <h2
    ...
    <form @submit.prevent="handleSubmit" class="space-y-4">
      ...
      <button
        type="submit"
        :disabled="loading"
        class="w-full py-2 px-4 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 text-white font-medium rounded-lg transition-colors duration-200 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
      >
        {{ loading ? '로그인 중...' : '로그인' }}
      </button>
    </form>
