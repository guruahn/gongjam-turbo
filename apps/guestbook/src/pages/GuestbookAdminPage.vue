    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8 max-w-7xl">
      ...
      <div class="mb-8">
        ...
        >
          ...
          <button
            @click="handleSignOut"
            class="inline-flex items-center justify-center px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
          >
            로그아웃
          </button>
        </div>
      ...
      >
        ...
        <div v-if="successMessage || errorMessage" class="px-6 pt-6">
          ...
          >
            <svg
              class="w-5 h-5 text-red-400 mr-3 mt-0.5"
              fill="currentColor"
              viewBox="0 0 20 20"
            >
              <path
...
// 초기 로드
onMounted(() => {
  console.log('GuestbookAdminPage mounted');
  loadEntries();
});
</script>
